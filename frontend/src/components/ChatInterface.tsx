...
export default function ChatInterface() {
  ...
  return (
    <div className="flex h-[600px]">
      {/* Sidebar */}
      <div className="w-64 bg-gray-50 border-r dark:bg-gray-900 dark:border-gray-800">
        <div className="p-4">
          <button
        ...
        <div className="border-t p-4 dark:border-gray-800">
          ...
          >
            <input
              ...
              disabled={isLoading}
              className="flex-1 px-4 py-2 text-sm border rounded-lg focus:outline-none focus:ring-2 focus:ring-primary disabled:opacity-50 disabled:cursor-not-allowed dark:bg-gray-800 dark:border-gray-700"
            />
            <button
              type="submit"
